...
%TODO Atualizar o texto, falando da carteirinha provisória, etc
...
no seu cartão USP na COSEAS, ao lado do banedejão Central.
...
em alguns bandejões existe uma alternativa vegetariana ao prato principal. %FIXME Quais?
...
você pode usá-la nos outros Bandejões, mas não é garantido que ela fique cheia. %FIXME Melhorar o texto
