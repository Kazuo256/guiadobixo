...
%\figura{mapausp}
\pagebreak
\figura{bandex_calvin} %FIXME passar essa imagem para preto e branco
...
a Veterinária, mas por enquanto é apenas uma lenda.
...
comando \linebreak{\tt \$ bandex -b <nome\_do\_bandejao>} na Rede Linux. Mas se você tiver
...
\figura{bandejao} %FIXME criar uma tabela atualizada a partir do /img/src/bandex.xlsx
\pagebreak
