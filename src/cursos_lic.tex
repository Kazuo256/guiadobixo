...
em matemática" ou "Tem que gostar bastante, né?" quando dizeram o seu curso para as 
outras pessoas.
...
\bf{professores}!, aqueles que sanam as dúvidas dos outros, então foquem em
...
temas que viram na escola e terão oprtunidades para melhorar práticas de ensino.
...
Se me permitem fazer uma comparação, eu diria que o curso de Licenciatura é uma
Eevee, que por si só é uma belezinha e evolui de diferentes e belas foramas
no decorrer do curso. Garanto que a USP porporcionrá diferentes oportunidades para
...
matérias por semestre como era no Ensino Médio, mas saibam que as matérias da graduação exigem
 bastante dedicação. Portanto, assistam as aulas, tirem as suas dúvidas e façam as famigeradas listas. 
\item Podem passar horas estudando até rachar, ser o nerd da turma e diminuir com
 isso o tempo de faculdade. Inclsuive, vocês seriam bons candidatos a RD, já pensaram nisso? 
...
\item O tão difícil "meio-termo"... É um ideal difícil de ser conquistado; afinal,
  ...
  dos professores por se formar de um a três anos a mais e ainda
  vão participar das melhores baladas (esperamos que tudo volte ao "normal" durante
  o período da graduação)\footnote{eae covid tá chatão já em mano}. Se isso não é 
bom, então vou voltar a fazer as minhas listas de Cálculo...
