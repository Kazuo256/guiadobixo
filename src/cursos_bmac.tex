...
\begin{itemize}
  ...
  \item \textbf{Habilitação em Comunicação Científica (ECA)}: A habilitação em
    ...
    habilitação. Por outro lado, alunes da habilitação têm vagas reservadas numa
  ...
  \item \textbf{Habilitação em Saúde Pública (FSP)}: É uma das habilitações mais
    ...
    metrô Clínicas) e você terá aula com alunes não só do IME, mas também dos
...
Muites alunes do BMAC já trabalham e hoje em dia o mercado de trabalho está bem atrativo para elus.
...
bem flexível, e es alunes costumam manter um bom diálogo com os coordenadores do
curso (Sônia e Mané, decorem esses nomes) a fim de melhorá-lo. Também não se intimidem
em falar com es veteranes que fazem esse curso, o pessoal é muito gente boa e bem disposto.
