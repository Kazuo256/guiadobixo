...
algumes veteranes falando sobre AACCs (Atividades Acadêmico-Científico-Culturais),
...
É muito importante lembrar que vocês mesmes têm que ir atrás dessas
...
atividades complementares para alunes do curso de Licenciatura em
...
para alunes de todos os Bacharelados do IME (ou seja, todos os cursos menos a
Licenciatura). Ao todo, precisam ser cumpridas 240 horas de AACs ao longo do curso.

A realização dessas horas é obrigatória desde 2020, então vocês podem encontrar
váries veteranes que não fazem ideia da existência disso aí.
