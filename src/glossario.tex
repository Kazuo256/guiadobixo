...
{\bf H.U. (Hospital Universitário):} para onde são mandados bixes que se machucam no Trote.
...
{\bf Vet (Veterinária):} para onde são mandados biches que se machucaram no
trote.
