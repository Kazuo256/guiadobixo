...
{\bf IC (Iniciação Científica):} grupo de estudantes, coordenado por um professor, que
...
{\bf P1, P2, P3:} não confundam com as do item das matérias. Aquelas eram AS P1, P2, P3;
...
{\bf Psico:} para onde são mandados os bixes (e veteranes também) que querem plantões
psicológicos porque saúde mental é importante e deve ser tratada com seriedade, Porra.
