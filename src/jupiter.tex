...
Talvez você esteja estranhando e pensando "me falaram que o Portal de Serviços da USP
que faz essas coisas" e tecnicamente você não está errado o \url{https://portalservicos.usp.br} tem exatamente as mesmas funções que o JupiterWeb dentro da aba Graduação e algumas outras tudo condensado num só site para facilitar o acesso incluindo a versão da pós do JupterWeb: o Janus,
...
Você deve estar se perguntando então por que nosso guia foca no Jupiter invés do Olimpo então? Basicamente porque a gente quer os dois portais fazem a mesma coisa e por estamos acostumados com o Júpiter.
