...
Aqui é onde se solicita o Cartão USP e o BUSP. Cartão USP é o que chamamos de carteirinha, ela serve para entrar no bandejão, no CEPE, pagar meia, entre outras coisas, é imprescindível que você a solicite (aproveita e já faz isso mesmo com as aulas estando on-line, assim quando voltarmos às aulas presenciais a sua carteirinha já estará te esperando!). Já o BUSP é o bilhete único da USP, com ele você pode utilizar os 3 circulares de graça, ou seja solicite esse também 
