...
{\bf Biblioteca:} Para se inscreverem, basta comparecerem à biblioteca munidos
do cartão USP, definitivo ou provisório. O empréstimo é unificado, sendo
possível retirar livros em qualquer uma das bibliotecas da USP mediante
...
vivência entre aulas. Acessem: \url{http://bcc.ime.usp.br/matrusp}
