...
já que toda a teoria da Computação envolve Matemática e, como futuros possíveis pesquisadores, 
...
se você não gostou de nenhuma, não é obrigatório escolher uma delas. Aliás, é 
...
de alguma trilha ganha um diploma com uma nota de ênfase em alguma área da Computação, então, se
