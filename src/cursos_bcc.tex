...
ênfase em alguma área da computação. Vocês perceberão que se não bastasse o curso ter
um monte de optativas, para completar uma trilha, você tambpem tem escolhas,
sendo divididas em blocos onde você deve completar $x$ matérias de um total de $y$, 
sendo $y > x$, para ter a trilha completa, confuso? talvez, mas não se preocupem,
está tudo bem explicado aqui:\url{https://bcc.ime.usp.br/principal/vida_academica/grade.html} ou
\url{https://akafts.github.io/yggdrasil2/}, sem falar das matérias 
MAC0101 e MAC0102 (palestrinha 1 e palestrina 2), feitas justamente para \sout{aumentar sua nota} 
que você descubra como o BCC é um
