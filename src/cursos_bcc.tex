...
um monte de optativas, para completar uma trilha, você tambpem tem escolhas, ou seja,
além de fazerem a trilha que mais te agradem, vocês podem escolher dentro da trilha as materias
que mais de agradem. Confuso?, quer saber mais especificamente quais materias compõem cada trilha
e como termina-las, além do links já citados e do apoio ao bcc que podem te guiar, temos 
as matérias MAC0101 (palestrinha 1) e MAC0102 (palestrina 2), 
feitas justamente para \sout{aumentar sua nota} que vocês conheçam as 
possibilidades de áreas e trilhas e como o BCC é um curso divertido
